...
import { JsonSnapshotProvider, createCareerSeed, diffSnapshots, formatDiffReport, normalizeSnapshot } from "./pipeline.mjs";
...
assert.equal(createCareerSeed(rawB).sourceSnapshotHash, snapshotB.contentHash);
