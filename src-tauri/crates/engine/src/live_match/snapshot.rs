...
impl LiveMatchState {
    ...
    pub fn snapshot(&self) -> MatchSnapshot {
        ...
        MatchSnapshot {
            ...
            max_substitution_windows: self.substitution_rules.max_windows,
            home_substitution_windows_used: self.home_substitution_windows.len() as u8,
            away_substitution_windows_used: self.away_substitution_windows.len() as u8,
