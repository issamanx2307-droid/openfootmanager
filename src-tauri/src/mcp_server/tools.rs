...
pub fn build_tool_router(context: &Arc<McpContext>, disabled: &[String]) -> OfmToolRouter {
            ...
            if !disabled.contains(&$name.to_string()) {
                ...
                router.add_route(ToolRoute::new_dyn(
                    ...
                    move |tool_context| {
                        let ctx = ctx.clone();
                        Box::pin(async move {
                            let $param_key = match require_string_param(
    ...
    real_tool!(
        "game_is_finished",
        "Check if the season/game is complete",
        tools_impl::info::game_is_finished
    );
    real_tool!(
        "info_game_summary",
        "High-level game overview: date, position, finances, next match",
        tools_impl::info::info_game_summary
    );
    real_tool!(
        "info_standings",
        "League table as formatted text",
        tools_impl::info::info_standings
    );
    real_tool!(
        "info_fixtures",
        "Upcoming/past fixtures",
        tools_impl::info::info_fixtures
    );
    real_tool!(
        "info_finances",
        "Financial overview + ledger",
        tools_impl::info::info_finances
    );
    real_tool!(
        "info_news",
        "Recent news articles",
        tools_impl::info::info_news
    );
    real_tool!(
        "info_season_context",
        "Season phase and transfer window status",
        tools_impl::info::info_season_context
    );
    real_tool!(
        "info_match_preview",
        "Preview of next match (opponent, form, squad overview)",
        tools_impl::info::info_match_preview
    );
    real_tool!(
        "training_get",
        "Current training settings + fitness overview",
        tools_impl::training::training_get
    );
    real_tool!(
        "squad_get",
        "Squad overview with player IDs, stats, and formation",
        tools_impl::squad::squad_get
    );
    real_tool!(
        "inbox_mark_all_read",
        "Mark all messages as read",
        tools_impl::inbox::inbox_mark_all_read
    );
    real_tool!(
        "inbox_clear_old",
        "Clear old messages",
        tools_impl::inbox::inbox_clear_old
    );
    real_tool!(
        "staff_get",
        "List all staff (your team + available)",
        tools_impl::club::staff_get
    );
    real_tool!(
        "season_check_complete",
        "Check if season is finished",
        tools_impl::season::season_check_complete
    );
    real_tool!(
        "game_save",
        "Persist current game",
        tools_impl::game::game_save
    );
    real_tool!(
        "time_advance",
        "Advance one day (match forced to delegate mode). Includes round summary on match days",
        tools_impl::time::time_advance
    );
    real_tool!(
        "squad_auto_set_pieces",
        "Auto-assign best set-piece takers",
        tools_impl::squad::squad_auto_set_pieces
    );
    real_tool!(
        "season_advance",
    ...
    real_tool!(
        ...
        "Fast-forward to next fixture",
        tools_impl::time::time_skip_to_match_day
    );
    real_tool!(
        "time_check_blockers",
        "Check if anything blocks time advancement",
        tools_impl::time::time_check_blockers
    );
    real_tool!(
        "club_request_board_support",
        "Request board financial support",
        tools_impl::club::club_request_board_support
    );
    real_tool!(
        "club_request_marketing",
        "Request marketing campaign",
        tools_impl::club::club_request_marketing
    );
    real_tool!(
        "club_request_sponsor_pitch",
        "Request sponsor pitch",
        tools_impl::club::club_request_sponsor_pitch
    );
    real_tool!(
        "scout_get_reports",
        "Get completed scout reports",
        tools_impl::scouting::scout_get_reports
    );
    real_tool!(
        "season_get_awards",
        "Get end-of-season awards",
        tools_impl::season::season_get_awards
    );
    ...
    id_tool!(
        "info_player_profile",
        "Detailed player card (attributes, stats, contract, morale)",
        player_id_schema(),
        player_id,
        tools_impl::info::info_player_profile
    );
    id_tool!(
        "info_player_stats",
        "Season + career stats for a player",
        player_id_schema(),
        player_id,
    ...
    id_tool!(
        ...
        message_id_schema(),
        message_id,
        tools_impl::inbox::inbox_mark_read
    );
    id_tool!(
        "inbox_delete",
        "Delete a message",
        message_id_schema(),
        message_id,
        tools_impl::inbox::inbox_delete
    );
    id_tool!(
        "transfer_toggle_listed",
        "Toggle player transfer-listed status",
        player_id_schema(),
        player_id,
        tools_impl::transfers::transfer_toggle_listed
    );
    id_tool!(
        "transfer_toggle_loan",
        "Toggle player loan-listed status",
        player_id_schema(),
        player_id,
        tools_impl::transfers::transfer_toggle_loan
    );
    id_tool!(
        "contract_clear_exit_intent",
        "Remove exit intent from contract",
        player_id_schema(),
        player_id,
        tools_impl::contracts::contract_clear_exit_intent
    );
    id_tool!(
        "contract_preview_termination",
        "Preview cost of terminating contract",
        player_id_schema(),
        player_id,
        tools_impl::contracts::contract_preview_termination
    );
    id_tool!(
        "contract_terminate",
        ...
        player_id_schema(),
        player_id,
        tools_impl::contracts::contract_terminate
    );
    id_tool!(
        "staff_hire",
        "Hire an unattached staff member",
        staff_id_schema(),
        staff_id,
        tools_impl::club::staff_hire
    );
    id_tool!(
        "staff_release",
        ...
        staff_id_schema(),
        staff_id,
        tools_impl::club::staff_release
    );
    id_tool!(
        "game_select_team",
        "Pick a team to manage",
        team_id_schema(),
        team_id,
        tools_impl::game::game_select_team
    );
    id_tool!(
        "game_load_save",
        ...
        save_id_schema(),
        save_id,
        tools_impl::game::game_load_save
    );
    ...
    id_tool!(
        "scout_youth_cancel",
        "Cancel youth scouting",
        assignment_id_schema(),
        assignment_id,
    ...
    custom_tool!(
        "squad_set_formation",
        "Change formation (also reassigns outfield positions by defending ability)",
        build_schema(
            &[(
                "formation",
                "string",
        ...
        args,
        {
            let formation = match require_string_param(args, "formation") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "squad_set_starting_xi",
        "Set starting eleven by player IDs",
        build_schema(
            &[(
                "player_ids",
                "array",
                "Ordered list of 11 player IDs for the starting eleven"
            )],
            &["player_ids"]
        ),
        ctx,
    ...
    custom_tool!(
        ...
        build_schema(
            &[(
                "play_style",
                "string",
                "Play style: Attacking, Defensive, Possession, Counter, HighPress, Balanced"
            )],
            &["play_style"]
        ),
        ctx,
        args,
        {
            let style = match require_string_param(args, "play_style") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "squad_set_match_roles",
        "Set captain and set-piece takers by player ID",
        build_schema(
            &[
    ...
    custom_tool!(
        "squad_set_player_role",
        "Set player squad role (Senior/Youth)",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
                ("squad_role", "string", "Squad role: Senior or Youth")
            ],
        ...
        args,
        {
            let pid = match require_string_param(args, "player_id") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let role = match require_string_param(args, "squad_role") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "training_set_focus_intensity",
        "Set team training focus and intensity",
        build_schema(
            &[
                (
                    "focus",
                    "string",
                    "Training focus: Physical, Technical, Tactical, Defending, Attacking, Recovery"
                ),
                (
                    "intensity",
                    "string",
        ...
        args,
        {
            let focus = match require_string_param(args, "focus") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let intensity = match require_string_param(args, "intensity") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "training_set_schedule",
        "Set weekly training schedule (Intense/Balanced/Light)",
        build_schema(
            &[(
                "schedule",
                "string",
                "Weekly training schedule: Intense, Balanced, Light"
            )],
            &["schedule"]
        ),
        ctx,
        args,
        {
            let schedule = match require_string_param(args, "schedule") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "training_set_groups",
        "Set training groups with per-group focus overrides",
        build_schema(
            &[(
                "groups_json",
                "string",
                "JSON array of TrainingGroup objects"
            )],
            &["groups_json"]
        ),
        ctx,
        args,
        {
            let groups_json = match require_string_param(args, "groups_json") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "training_set_player_focus",
        "Set individual player training focus",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
                (
                    "focus",
                    "string",
                    "Individual training focus (omit to clear)"
                )
            ],
            &["player_id"]
        ),
    ...
    custom_tool!(
        "transfer_make_bid",
        "Make a transfer bid; includes negotiation feedback",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID to bid on"),
                ("fee", "integer", "Transfer fee amount")
            ],
            &["player_id", "fee"]
        ),
        ctx,
        args,
        {
            ...
            let fee = match require_u64_param(args, "fee") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "transfer_preview_bid",
        "Preview financial impact of a transfer bid",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
                ("fee", "integer", "Proposed transfer fee")
            ],
            &["player_id", "fee"]
        ),
        ctx,
    ...
    custom_tool!(
        "transfer_respond_to_offer",
        "Accept/reject an incoming offer",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
        ...
        args,
        {
            ...
            let oid = match require_string_param(args, "offer_id") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let accept = match require_bool_param(args, "accept") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "transfer_counter_offer",
        "Counter an incoming transfer offer",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
        ...
        args,
        {
            ...
            let fee = match require_u64_param(args, "requested_fee") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "transfer_market_browse",
        "Browse transfer/loan market with optional filters",
        build_schema(
            &[
                ...
                (
                    "listed_only",
                    "boolean",
                    "Only show transfer/loan listed players"
                ),
            ],
            &[]
        ),
    ...
    custom_tool!(
        "transfer_free_agent_offer",
        "Offer contract to a free agent",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
        ...
        args,
        {
            ...
            let wage = match require_u32_param(args, "weekly_wage") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let years = match require_u32_param(args, "contract_years") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "transfer_free_agent_preview",
        "Preview free agent contract financial impact",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
    ...
    custom_tool!(
        "contract_propose_renewal",
        "Propose contract renewal; includes negotiation feedback",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
                ("weekly_wage", "integer", "Proposed weekly wage"),
    ...
    custom_tool!(
        "contract_delegate_renewals",
        "Delegate contract renewals to assistant",
        build_schema(
            &[
                (
                    "player_ids",
                    "array",
                    "Player IDs to renew (omit for all expiring)"
                ),
                (
                    "max_wage_increase_pct",
                    "integer",
                    "Max wage increase percentage"
                ),
        ...
        args,
        {
            ...
            let max_pct = match require_u32_param(args, "max_wage_increase_pct") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let max_years = match require_u32_param(args, "max_contract_years") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "contract_preview_renewal",
        "Preview renewal financial impact",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
                ("weekly_wage", "integer", "Proposed weekly wage")
    ...
    custom_tool!(
        "contract_set_exit_intent",
        "Mark contract to let expire",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
                ("reason", "string", "Optional reason for exit intent")
            ],
            &["player_id"]
        ),
        ctx,
    ...
    custom_tool!(
        "inbox_get_messages",
        "Get messages (filterable by category, read status)",
        build_schema(
            &[
                ("category", "string", "Filter by message category"),
    ...
    custom_tool!(
        "inbox_resolve_action",
        "Resolve a message action (job offers, events, etc.)",
        build_schema(
            &[
        ...
        args,
        {
            let mid = match require_string_param(args, "message_id") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let aid = match require_string_param(args, "action_id") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "club_upgrade_facility",
        "Upgrade a facility level",
        build_schema(
            &[("facility", "string", "Facility name to upgrade")],
            &["facility"]
        ),
        ctx,
        args,
        {
            let facility = match require_string_param(args, "facility") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        ...
        args,
        {
            let query = match require_string_param(args, "query") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "info_player_match_history",
        "Match-by-match stats for a player",
        build_schema(
            &[
                ("player_id", "string", "Player entity ID"),
    ...
    id_tool!(
        "info_team_profile",
        "Detailed team view (squad, form, finances)",
        team_id_schema(),
        team_id,
        tools_impl::info::info_team_profile
    );
    ...
    id_tool!(
        ...
        team_id_schema(),
        team_id,
        tools_impl::info::info_team_stats
    );

    // info_team_match_history
    custom_tool!(
        "info_team_match_history",
        "Match-by-match stats for a team",
        build_schema(
            &[
                ("team_id", "string", "Team entity ID"),
                ("limit", "integer", "Max matches to return")
            ],
            &["team_id"]
        ),
        ...
        args,
        {
            let tid = match require_string_param(args, "team_id") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let limit = extract_u64_param(args, "limit").map(|n| n as usize);
    ...
    custom_tool!(
        ...
        build_schema(
            &[("team_id", "string", "Team entity ID (omit for own team)")],
            &[]
        ),
        ctx,
        args,
    ...
    custom_tool!(
        "scout_send",
        "Send scout to report on a player",
        build_schema(
            &[
                ("scout_id", "string", "Staff member ID to send"),
                ("player_id", "string", "Player ID to scout")
            ],
            &["scout_id", "player_id"]
        ),
        ctx,
        args,
        {
            let sid = match require_string_param(args, "scout_id") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let pid = match require_string_param(args, "player_id") {
    ...
    custom_tool!(
        ...
        build_schema(
            &[
                ...
                (
                    "region",
                    "string",
                    "Scouting region: Domestic or International"
                ),
                (
                    "objective",
                    "string",
                    "Scouting objective: Balanced, HighPotential, ReadySoon"
                ),
                (
                    "target_position",
                    "string",
        ...
        args,
        {
            ...
            match tools_impl::scouting::scout_youth_start(
                ctx,
                sid,
                region,
                objective,
    ...
    custom_tool!(
        ...
        build_schema(
            &[
                ...
                ("scout_id", "string", "New staff member ID")
            ],
        ...
        args,
        {
            let aid = match require_string_param(args, "assignment_id") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let sid = match require_string_param(args, "scout_id") {
    ...
    custom_tool!(
        ...
        build_schema(
            &[
                ...
                (
                    "team_id",
                    "string",
                    "Team to manage (required if world has no pre-assigned manager)"
                ),
            ],
        ...
        args,
        {
            let first = match require_string_param(args, "first_name") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let last = match require_string_param(args, "last_name") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let nat = match require_string_param(args, "nationality") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    if !disabled.contains(&"game_export_world".to_string()) {
        ...
        router.add_route(ToolRoute::new_dyn(
            Tool::new(
                "game_export_world",
                "Export world to JSON (saved in app data directory with auto-generated filename)",
                empty_input_schema(),
            ),
            move |_tool_context| {
                let ctx = ctx.clone();
    ...
    real_tool!(
        "game_list_saves",
        "List all saved games with manager name and date",
        tools_impl::game::game_list_saves
    );
    ...
    id_tool!(
        ...
        save_id_schema(),
        save_id,
        tools_impl::game::game_delete_save
    );

    // game_list_world_databases
    real_tool!(
        "game_list_world_databases",
        "List available world databases (built-in random + user JSON files)",
        tools_impl::game::game_list_world_databases
    );
    ...
    custom_tool!(
        ...
        args,
        {
            ...
            let mode = match require_string_param(args, "mode") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    custom_tool!(
        "match_command",
        "Apply a tactical command during a live match (substitution, formation change, etc.)",
        build_schema(
            &[(
                "command_json",
                "string",
                "Match command as JSON (see engine MatchCommand type)"
            )],
            &["command_json"]
        ),
        ctx,
        args,
        {
            let command_json = match require_string_param(args, "command_json") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
    ...
    real_tool!(
        "match_snapshot",
        "Get current live match state without advancing time",
        tools_impl::live_match::match_snapshot
    );

    // match_finish
    real_tool!(
        "match_finish",
        "Finish the live match, apply results, and clean up",
        tools_impl::live_match::match_finish
    );

    // match_team_talk
    custom_tool!(
        "match_team_talk",
        "Apply a team talk during half-time or full-time break",
        build_schema(
            &[
                (
                    "tone",
                    "string",
                    "Talk tone: calm, motivational, assertive, aggressive, praise, disappointed"
                ),
                (
                    "context",
                    "string",
                    "Match context: winning, losing, drawing"
                ),
            ],
            &["tone", "context"]
        ),
        ...
        args,
        {
            let tone = match require_string_param(args, "tone") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
            let context = match require_string_param(args, "context") {
                Ok(v) => v,
                Err(e) => return Ok(e),
            };
...
pub fn tool_catalog() -> Vec<(&'static str, &'static str, &'static str)> {
    vec![
        ...
        (
            "info_game_summary",
            "High-level overview: date, league position, finances, next match, unread messages",
            "Information",
        ),
        (
            "info_game_state",
            "Full game state as JSON (programmatic access)",
            "Information",
        ),
        (
            "info_standings",
            "Full league table with goal difference",
            "Information",
        ),
        (
            "info_fixtures",
            "Upcoming fixtures and recent results for your team",
            "Information",
        ),
        (
            "info_match_preview",
        ...
        (
            "info_player_profile",
            "Detailed player card with attributes and contract",
            "Information",
        ),
        (
            "info_player_stats",
        ...
        (
            "info_team_profile",
            "Detailed team view with squad summary",
            "Information",
        ),
        ("info_team_stats", "Team season statistics", "Information"),
        (
            "info_finances",
            "Financial overview with budget breakdown",
            "Information",
        ),
        ...
        (
            "time_skip_to_match_day",
            "Fast-forward to next match day",
            "Time",
        ),
        (
            "time_check_blockers",
        ...
        (
            "squad_get",
            "Squad overview with starting XI and bench",
            "Squad",
        ),
        ...
        (
            "squad_set_match_roles",
            "Set captain and set-piece takers",
            "Squad",
        ),
        (
            "squad_auto_set_pieces",
            "Auto-assign set-piece takers based on attributes",
            "Squad",
        ),
        (
            "squad_set_player_role",
            "Set player squad role (starter/substitute/reserve)",
            "Squad",
        ),
        // Training
        ...
        (
            "training_set_focus_intensity",
            "Set training focus and intensity",
            "Training",
        ),
        (
            "training_set_schedule",
        ...
        (
            "training_set_groups",
            "Set training group assignments",
            "Training",
        ),
        (
            "training_set_player_focus",
        ...
        (
            "transfer_free_agent_preview",
            "Preview financial impact of signing a free agent",
            "Transfers",
        ),
        // Contracts
        (
            "contract_propose_renewal",
            "Propose contract renewal",
            "Contracts",
        ),
        (
            "contract_delegate_renewals",
            "Delegate contract renewals to staff",
            "Contracts",
        ),
        (
            "contract_set_exit_intent",
            "Set exit intent on a player contract",
            "Contracts",
        ),
        (
            "contract_clear_exit_intent",
            "Clear exit intent on a player contract",
            "Contracts",
        ),
        (
            "contract_terminate",
        ...
        (
            "contract_preview_renewal",
            "Preview financial impact of contract renewal",
            "Contracts",
        ),
        (
            "contract_preview_termination",
        ...
        (
            "club_request_board_support",
            "Request board support for transfer budget or wage bill",
            "Club",
        ),
        (
            "club_request_marketing",
        ...
        (
            "scout_youth_cancel",
            "Cancel youth scouting assignment",
            "Scouting",
        ),
        (
            "scout_youth_reassign",
        ...
        (
            "game_list_world_databases",
            "List available world databases",
            "Game Lifecycle",
        ),
        (
            "game_is_finished",
        ...
        (
            "match_step",
            "Advance the live match by N minutes",
            "Live Match",
        ),
        (
            "match_command",
            "Apply a tactical command during a live match",
            "Live Match",
        ),
        (
            "match_snapshot",
            "Get current match state without advancing time",
            "Live Match",
        ),
        (
            "match_finish",
            "Finish the match, apply results",
            "Live Match",
        ),
        (
            "match_team_talk",
            "Apply a team talk during a match break",
            "Live Match",
        ),
        (
